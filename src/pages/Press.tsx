  ...
  return (
    <Layout>
      <Seo
        ...
        description="Пресс-материалы, публикации, экспертные комментарии и контакты пресс-службы Голубев Консалтинг. Скачать логотип, фото и описание компании для СМИ."
      />
